...
import { Stethoscope, ClipboardList, Shield, Users, ArrowRight } from 'lucide-react';
...
const HomePage: React.FC = () => {
    return (
        <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
            {/* Navigation */}
            <nav className="bg-white shadow-sm sticky top-0 z-50 backdrop-blur-lg">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center">
                            <Stethoscope className="h-8 w-8 text-blue-600" />
                            <span className="ml-2 text-xl font-semibold text-gray-900">MedRecord</span>
                        </div>
                    </div>
                </div>
            </nav>
                    ...
                    <div className="lg:grid lg:grid-cols-12 lg:gap-8 items-center">
                        ...
                        <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
                            ...
                            <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl">
                                Securely store, access, and manage your medical history in one place.
                ...
                <section className="bg-white py-16">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="text-center">
                            <h2 className="text-3xl font-extrabold text-gray-900">Why Choose MedRecord?</h2>
                        </div>
                        <div className="mt-10 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
                            <FeatureCard
                                Icon={Shield}
                                title="Secure Storage"
                                description="Your medical data is encrypted and stored securely following HIPAA guidelines."
                            />
                            <FeatureCard
                                Icon={ClipboardList}
                                title="Easy Access"
